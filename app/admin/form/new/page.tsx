    ...
    return (
      <div className="p-8 max-w-2xl mx-auto flex flex-col items-center justify-center min-h-[70vh]">
        <div className="bg-[#111] p-12 rounded-3xl border border-white/10 text-center w-full shadow-2xl">
          ...
          <h2 className="text-3xl font-extrabold text-white mb-4">Form Created Successfully!</h2>
          <p className="text-gray-400 mb-8 text-lg">Your form is now live and ready to accept responses.</p>
          
          <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-4 mb-8 flex items-center gap-4">
            <input
              type="text"
              readOnly
              value={`${typeof window !== 'undefined' ? window.location.origin : ''}/f/${createdFormId}`}
